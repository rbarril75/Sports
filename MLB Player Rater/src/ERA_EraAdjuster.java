...
public class ERA_EraAdjuster {
	...
	public static void main(String[] args) {
		...
		double longevity = dblRound(RS) / 100;
		double WLrating = W / 20 - L / 40;
		
		double pitchRating = base + dominance + longevity + WLrating;
		
		System.out.print("Pitching Rating: " + round(pitchRating));
